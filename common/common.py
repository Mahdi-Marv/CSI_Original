...
def parse_args(default=False):
    ...
    parser.add_argument('--dataset', help='Dataset',
                        choices=['mnist', 'waterbird', 'aptos','isic' , 'chest', 'brain','camelyon17' ,'cifar10', 'cifar100', 'imagenet'], type=str)
    parser.add_argument('--one_class_idx', help='None: multi-class, Not None: one-class',
                        default=None, type=int)
    parser.add_argument('--model', help='Model',
                        choices=['resnet18', 'resnet18_imagenet'], type=str, default='resnet18_imagenet')
    ...
    parser.add_argument("--save_score", help='save ood score for plotting histogram',
                        action='store_true')
    parser.add_argument('--brats', default=0, type=int)
